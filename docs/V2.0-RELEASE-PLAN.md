...
- [ ] Publish tag `v2.0` on GitHub with release notes and attach all split chunks + checksums + in-place update script.
- [ ] Verify downloadability and integrity via GitHub CLI.
